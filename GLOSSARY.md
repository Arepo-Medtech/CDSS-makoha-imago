...
| Register | "a ledger; there are 28; if it's not in one, it didn't happen" | `02_cdss-stack-augmented/primer_0_ecosystem_explainer.md` l.70; Arch §12.2 `02_cdss-stack-augmented/architecture_and_integration.md` l.511–512 | DEC-02 Closed (MET-2.2 §3.4) — the count is 30 since R29 and R30 were ratified; Primer 0's "28" is the retained 2026-09-01 sentence | R-n ids; register laws Arch §12.1 | Arch §12 |
