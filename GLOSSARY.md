...
| SPINE-n | MAK-FFC fabric requirement ids (Part 2, "The shared spine") | `03_makoha-butterfly-corpus/corpus-md/four-faces-corpus_v1.1.md` l.87 (Part 2), `:165` (SPINE-7) | — | ≠ release spine | MAK-FFC |
