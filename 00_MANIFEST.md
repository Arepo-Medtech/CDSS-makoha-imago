...
|---|---|---|
| root | `GLOSSARY.md` (12,063) — 38 house terms: quoted or pointed source by path and line, guarding ruling with its state, aliases and near-misses, home (survey-3 QI-0032) · `00_inventory_v1.3.txt` (24,257) — regenerated inventory with a header line; supersedes `00_inventory.txt` (retained; DEF-008; QI-0063) | Added — Proposed |
