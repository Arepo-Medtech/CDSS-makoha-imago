...
## Pinned strings repeated in ≥3 assets (JSON Schema vocabulary keys excluded — Copilot finding on PR #14 accepted; the earlier table listed them as 'keyword (not a value)')
