# Orphan candidate — CONTRACT-DEV-1.examples.jsonl

Target: `05_registers-and-contracts/CONTRACT-DEV-1.examples.jsonl`
...
- **Row changes:** row QI-0008 → state DISMISSED-NOT-BLOCKING; confidence 90; dismissed
