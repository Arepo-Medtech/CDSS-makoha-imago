# Orphan candidate — PROMPT-PRM-SERIES_index.md

Target: `11_prompts/PROMPT-PRM-SERIES_index.md`
...
- **Row changes:** row QI-0014 → state OPEN; confidence 80; calibrated_weight 2
