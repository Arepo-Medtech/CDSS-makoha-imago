...
Byte-count fixed point (ledger2.py, final run after every review fix): quoted = disk for HARDEN-1.2 (76468), HARDEN-3.2 (86892), 00_inventory_v1.3.txt (24257), INDEX-09.1 (4155), GLOSSARY.md (12137), tokens.css (2334) — regenerated by tools/seal.py from 00_inventory_v1.3.txt at every seal; verified against `stat -f%z` (RUN-REPORT §1).
